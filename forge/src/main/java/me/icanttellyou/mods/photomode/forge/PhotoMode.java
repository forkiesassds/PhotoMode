...
public class PhotoMode {
    ...
    private void screenEventHandler(ScreenEvent event) {
        ...
        if ((screen instanceof GameMenuScreen || usePauseScreenWorkarround.contains(screen.getClass().getSimpleName())) && event instanceof ScreenEvent.InitScreenEvent) {
            screen.addDrawableChild(new ButtonWidget(screen.width / 2 - 48, 8, 98, 20, new TranslatableText("gui.photomode"), (button) -> {
