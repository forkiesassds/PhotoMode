...
public class PhotoModeScreen extends Screen {
    ...
    private void initWidgets() {
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.translatable("gui.photomode.takescreenshot"), (button) -> {
            isTakingScreenshot = true;
        }).position(width / 2 - 49, height - 20).width(98).build());
    ...
    private void updateGui() {
        this.timeSlider.setText(Text.translatable("gui.photomode.time", this.timeSlider.value == 0.0f ? Text.translatable("gui.photomode.default") : (long)(this.timeSlider.value * 24000.0f)));
        this.fogSlider.setText(Text.translatable("gui.photomode.fog", (int)(this.fogSlider.value * 100.0f)));
        this.tiltSlider.setText(Text.translatable("gui.photomode.tilt", (int)(this.tiltSlider.value * 90.0f) == 30 ? Text.translatable("gui.photomode.default") : (int)(this.tiltSlider.value * 90.0f)).append(" ").append((int)(this.tiltSlider.value * 90.0f) == 30 ? Text.of("") : Text.translatable("gui.photomode.degrees")));
    }
